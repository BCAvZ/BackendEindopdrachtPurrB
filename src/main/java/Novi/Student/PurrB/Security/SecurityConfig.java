...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/clients/**").hasAuthority("USER")
                .requestMatchers("/users/**").hasAuthority("USER")
                .requestMatchers("/cats/**").hasAuthority("USER")
                .requestMatchers("/appointments/**").hasAuthority("USER")
                .requestMatchers(HttpMethod.GET, "/invoices").hasAuthority("USER")
                .requestMatchers("/invoices/**").hasAuthority("ADMIN")
                .requestMatchers("/upload").hasAuthority("USER")
                .requestMatchers("/download").hasAuthority("USER")
                .requestMatchers("/download/**").hasAuthority("USER")
